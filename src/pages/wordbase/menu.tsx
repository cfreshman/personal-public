  ...
  const handle = {
    ...
    challenge: (doCopy=false) => {
      return api.get('wordbase/challenge/hash').then(hash => {
        ...
        if (doCopy) {
          copy(`https://freshman.dev/wordbase/${challengeId}`.replace(/\/\/n/g, '/n'))
          setNew(false)
...
export const Support = () => {
  ...
  return <Style className='body'>
    ...
    `)}>
      ...
      <p className='support-links'>
        <a href={`http://twitter.com/intent/tweet?text=${encodeURIComponent(user ? `challenge me: freshman.dev/wordbase/new/${challengeHash}` : 'check out freshman.dev/wordbase')}`} onClick={e => {
        ...
        &nbsp;&nbsp; <a href={`https://www.facebook.com/sharer/sharer.php?` + new URLSearchParams({
          u: user ? `https://freshman.dev/wordbase/new/${challengeHash}` : 'https://freshman.dev/wordbase',
        ...
        &nbsp;&nbsp; <a href={`mailto:?` + new URLSearchParams({
          body: user ? `https://freshman.dev/wordbase/new/${challengeHash}\n\n(automated)` : 'https://freshman.dev/wordbase\n\n(automated)',
          subject: user ? 'Challenge me!' : 'Check out freshman.dev/wordbase!',
        }).toString()} onClick={e => {
          user && api.post('wordbase/i/new', { enable: true })
