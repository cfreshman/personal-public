...
import { useAnimate, useEventListener, useR, useStyle } from '../lib/hooks';
...
export default () => {
  usePageSettings({
    checkin: 'ink',
    background: '#fff', text_color: '#222',
    transparentHeader: true, invertHeader: true,
  })
  ...
  // useStyle(`
  // #inner-index#inner-index#inner-index #header .nav,
  // #inner-index#inner-index#inner-index #header .user,
  // #inner-index#inner-index#inner-index #online * {
  //   color: #fff !important;
