...
export const open_howto = () => open_popup(close => <>
  <InfoBody id='letterpress-menu-howto' className='middle-column'>
    ...
    <div className='center-column' style={S(`font-size: .8em`)}>
      ...
      <HalfLine />
      <div>you can spell words using any tiles on the board. you will keep any 'unlocked' tiles. a player's tile is locked when surrounded by tiles also owned by that player</div>
    </div>
    <HalfLine />
    <div className='center-column' style={S(`font-size: .8em`)}>
      <b>install:</b>
