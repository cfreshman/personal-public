  ...
  return <Style>
    <InfoBody>
      <InfoSection labels={['getting started on freshman.dev']}>
        ...
        <div><A href='/lettercomb' /> - best one (in my opinion)</div>
        <div><A href='/letterpress'/> - also great, longer words</div>
        <div><A href='/wordbase'/> - original app was most popular</div>
        <div><A href='/quadbase'/> - four players!</div>
        <div><A href='/petals'/> - new, still under development</div>
        ...
        <div>when someone opens it, you'll automatically follow each other. so u can use various social features with them like word game challenges</div>
        <HalfLine />
        ...
        <HalfLine /> */}
        <div><b>play a multiplayer couch game!</b></div>
        <div><A href='/matchbox.html'>/matchbox.html</A></div>
        <div>uses phones as controllers</div>
        <HalfLine />
        <div><b>track habits! <A href='/tap'/></b></div>
        <HalfLine />
        <div><b>and much more! view at <A href='/search'/></b></div>
        <HalfLine ratio={2} />
