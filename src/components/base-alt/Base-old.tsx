...
import { S, dev, is_mobile_not_watch, isWatch, is_mobile, list, toStyle, set } from '../../lib/util';
import { A, HalfLine, Help } from '../Info';
import { Base as OriginalBase } from '../base/Base';
import { Contact } from '../base/Contact';
import { Projects } from '../base/Projects';
import { store } from 'src/lib/store';
import { Dangerous } from '../individual/Dangerous';
import { About } from './About';
import { get_tracks, track_ids, track_lists, track_play } from 'src/lib/track_player';
...
export const Base = () => {
  ...
  * {
  ...
  const page = (x => 'contents contact about tldr list log'.includes(x) ? x : 'home')(parseSubpath().replace('/', '') || subdomain)
      ...
      <div id='box'>
        ...
        <div id="title">
          ...
          `)}>
            ...
            &nbsp;
            {theme_song?.flavor ? <span>{theme_song.flavor}</span> : undefined}
        ...
        `)}>
          ...
          `)}>
            <Switch>
              ...
              <Route exact path={'/(|home|man|et|monstera)'}>
                <div id='box-inner-home' style={toStyle(`
                display: flex;
                flex-direction: column;
                align-items: center;
                // justify-content: center;
                ...
                `)}>
                  <div className='column'>
                    ...
                    <span>enjoy? <A href='/list'>donate $1/mo</A></span>
                  </div>
                  <HalfLine />
                  {/* {is_mobile_not_watch ? '' : <p>
                    <i>you might be looking for</i>
                  </p>} */}
                  {/* <span style={toStyle(`
                  // position: absolute;
                  // top: 0; left: 0;
                  ...
                  `)}>Notable public projects:</span> */}
                  <A href='/letterpress'>letterpress (best word game imo)</A>
                  {/* <A href='https://github.com/sponsors/cfreshman'>sponsor me! ($1/mo)</A> */}
                  {/* <A href='/capitals'>capitals (arcade-y word game)</A>
                  <A href='/wordbase'>wordbase (popular word game)</A> */}
                  <A href='/lettercomb'>lettercomb (prev discont. word game)</A>
                  <A href='/wordbase'>wordbase (discontinued word game)</A>
                  <A href='/greeter'>greeter (social diary)</A>
                  <HalfLine />
                  <A href='/wordle/leaderboard'>wordle bot leaderboard</A>
                  {/* <div><A href='https://dinder.social'>Dinder</A> / <A href='https://crowdmeal.app'>Crowdmeal</A></div> */}
                  {/* <A href='https://pico-repo.com'>pico-repo.com</A> */}
                  {/* <A href='/follow-sync'>sync Twitter / Mastodon follows</A> */}
                  {/* <A href='https://tally.gallery'>tally.gallery</A> */}
                  <A href='/fishbowl'>fishbowl (party game for 6-18)</A>
                  <A href='/matchbox'>matchbox (joycon couch game)</A>
                  {/* <A href='/fishbowl'>BRKN <s>fishbowl (party game for 6-18)</s></A> */}
                  {/* <A href='https://spot.freshman.dev'>smolify</A> */}
                  ...
                  {/* <A href='/raw/paths'>path planning demo</A> */}
                  ...
                  {/* <A href='/donoboard'>donoboard (sponsor me! $1/mo)</A> */}
                  <A href='/search'>something else? (open search)</A>
                  {/* <span>...and more: <A href='/contents'>/contents</A></span> */}
                </div>
              </Route>
              <Route exact path='/tldr'><TLDR /></Route>
              <Route exact path='/list'><List /></Route>
              <Route exact path='/log'><Log /></Route>
              <Route exact path='/about'><About /></Route>
              <Route exact path='/contents'><Projects inner={true} /></Route>
        ...
        <div id='user-controls' className="row end">
          {/* &nbsp; */}
          {viewer ? <>
            <span>
              {/* hi {viewer}! */}
