...
db.queueInit(() => {
    ...
    'site admin mod user player chat settings invite join orange blue you wordbase picorepo dinder login contact wordle hash public about calendar delete open slte s1te hangout easy medium hard impossible strategist wordsmith beast speedy loading invalid username sername ai gail gai selfchat'.split(' ').map(async special => {
        try {
