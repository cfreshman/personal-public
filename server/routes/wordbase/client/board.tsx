import { range, sample, dist, array, randi, keyOf } from '../../util';
import { AI } from './ai';
...
export class Board {
    ...
    static readonly BASE = [Board.ROWS - 1, 0];
    board: ITile[][];
            ...
            for (const condition of winConditions) {
                switch (condition) {
                    case GameSettings.WinConditions.NORMAL:
                        ...
                        if (!this.board[Board.BASE[1 - pN]].some(tile => tile.owner === pN)) return false
                        break
